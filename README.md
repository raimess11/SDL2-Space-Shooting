...
* Custom collision detection for player, enemy ships, and projectiles
* Input handling using SDL2 to manage smooth player movement and shooting controls
* Rendering pipeline using SDL2 to draw the player ship, enemies, bullets, and background elements
* Basic game loop implementation (update → render → repeat)
